...
public class ArrayEquals {
    public static void main(String[] args) {
        ...
        if (Arrays.equals(nums1, nums2)) {
            System.out.println("nums1 and nums2 are matching");
        } else {
            System.out.println("nums1 and nums2 are not matching");
        }

        if (Arrays.equals(nums2, nums3)) {
            System.out.println("nums2 and nums3 are matching");
        } else {
            System.out.println("nums2 and nums3 are not matching");
        }
